...
cl = BROKOLI.LINE()
cl.login(token="ErDCIpE0kBS2fLiT0bOb.nakaT7JeuPZkMr8GgV8sgW.gjH3oKGH2d4aNie8QXjYw9CuhXnUIQ2HJtFvu8mZp9w=")
cl.loginResult()

ki = BROKOLI.LINE()
ki.login(token="ErGVSiBZbpDzC0SlW5nb.Q3mRz/4oKvUxi7TGxPqocW.b2YulHceJC8gHD986whTZypZ7du9OHWyqjK9MkVV43A=")
ki.loginResult()

ki2 = BROKOLI.LINE()
ki2.login(token="ErL1NZcf6FQDZG7DL2Tf.AaE7rrH4KgU3d8u16qquxW.IcuIOgOgtONKd9he61oU+AzcMBf5CHoO4PqFCOFa10Y=")
ki2.loginResult()

ki3 = BROKOLI.LINE()
ki3.login(token="Er95aZkEnBvid9LIaGVa.5m4zScSnfY4d6dqUI3NMEG.UzkJ++txfRMPT1SyQfqROBJIC2HI3I6jcm/DlMqo3Ds=")
ki3.loginResult()

ki4 = BROKOLI.LINE()
ki4.login(token="ErorBeOBg48X8zZqYCEa.ua3SzHy4uk0Z/ncC+5JRcG.fpdk7zEzgaU02UFQfBN7YqQSDbpX/txx4GaJpsXz7Dg=")
ki4.loginResult()q

ki5 = BROKOLI.LINE()
ki5.login(token="Er6GWM9d9xSjsOYswmua.avnt6akry+Y/GCf14Nt4/G.kBNMXD7mGembHVv8HP7o8BGRm0GwLJ0OXba+FapErS8=")
ki5.loginResult()

ki6 = BROKOLI.LINE()
ki6.login(token="ErlvU8Nj9yFvqXmjEunb.EDt91WylGy8tnhx8gFRzYW.y2DjEHoDoTcLM+G2DnQu3VpbccmUTaLNLV1/e52ZxfA=")
ki6.loginResult()

ki7 = BROKOLI.LINE()
ki7.login(token="ErSXyKpwSBkUtA3EUMs8.PRvVS1DAF2JmWHKyW0pV/a.Az60FgreWGYNgiX8VJu78X07u8zpk2LCIHTEyCfVpdI=")
ki7.loginResult()

ki8 = BROKOLI.LINE()
ki8.login(token="ErlI3Yspf3UWfGxSibk8.L19GkyWruD+ew3RCMeAiIa.iuf/6+AyAKkDp8J/jj9HeeHTkBaUYWHKBddQzVRcFwY=")
ki8.loginResult()

ki9 = BROKOLI.LINE()
ki9.login(token="ErcTADgdw9vx1fsaBts1.or6pUXGzz/pGcKpb6mKk8q.k5pO2Utq+bqv3u0vwGsonxy1H+dqALhGqd/1oviZrQc=")
ki9.loginResult()

ki10 = BROKOLI.LINE()
ki10.login(token="ErMRpcfl950GtfV1bmda.3dZ0I0/bHe6jQyypLE7P/G.OSV9vUBf5VaTWkY89gRhoOhxOEvRf2nw7FZiPt2cdIU=")
ki10.loginResult()

k1 = BROKOLI.LINE()
k1.login(token="ErmpqlmGf2VbHQP9cBs3.JiNeRRKZyVLX/PqW3wMD0W.51LNm943VOdkEWVN+l46Gg/yAXmlFdOrle5Ol/4UP94=")
k1.loginResult()

k2 = BROKOLI.LINE()
k2.login(token="ErYfjEZGrDTGqiVpWdEa.vjPTRAYcV/llrv59tHu/kG.SF7emyVnZdBO+cOPi5rr6WWz48qCy2oqDR5MYHna1bU=")
k2.loginResult()

k3 = BROKOLI.LINE()
k3.login(token="ErNJNXzOr46Ehe9GyE60.p7QySxh/6/kF4vLm0BffKa.jwcb+JzqhEr/T0TWozqtAJPp6bVPi/F9Wju83ztqRyc=")
k3.loginResult()

k4 = BROKOLI.LINE()
k4.login(token="ErCLstXPoU4dR8O1xCx0.xe48M11YLbGrdDa7/X1oua.U7qW6QSy2GGOENic4uBl39dyTkXN6X4JUDPhyLLl4K8=")
k4.loginResult()

k5 = BROKOLI.LINE()
k5.login(token="Er9QtD8CTiRPQ9Pgn8g0.geEQ57Zy1vzic+fjzM12ya.XcqKkG6GB7WN59Oua6Zk8dvZrQWYFQ9UsNf4dRMmMtI=")
k5.loginResult()

k6 = BROKOLI.LINE()
k6.login(token="ErNuuN2czFs61VA514r0.oDnb8SWaqTtimVILu4w/Ga.siYYiLulRx6bNWQ8YjRxfhWz5YdqFBFMAouHftmmt0M=")
k6.loginResult()

k7 = BROKOLI.LINE()
k7.login(token="ErQw8kUisU0KhOImBr9a.WLqeSjyCeS/vi26WpCSRQG.ujzpgs3CLY03nXsYFjZKpUcgP8RiKPP7OGgGtIpftTI=")
k7.loginResult()

print u"╔════════════════\n╠[❂͜͡➣login success CYBERTK\n╚════════════════"
reload(sys)
...
║   ◄]·♦⚽·Owner :E®y·⚽♦·[►
╠════════════════════
╠[❂͜͡➣[¢̶̲̅ᴏ̶̲̅ᴍ̶̲̅ᴍ̶̲̅ᴀ̶̲̅ɴ̶̲̅ᴅ̶̲̅ ̶̲̅ɪ̶̲̅ɴ̶̲̅ ̶̲̅g̶̲̅ʀ̶̲̅ᴏ̶̲̅ᴜ̶̲̅ᴘ̶̲̅]
╠════════════════════
╠[❂͜͡➣ [кι¢к:「мι∂」]
╠[❂͜͡➣ [ιηνιтє:「мι∂」]
╠[❂͜͡➣ [¢αη¢єℓ]
...
╠[❂͜͡➣ line://ti/p/~kibasz.com
╠════════════════════
║Support By ~☆  €̤̥̦̗͔͐̉̐̂́d̺̯͕̮̳͛̍͑̀͋̈͞͞͠͡d͔̭̜̝̻̠́̂̌̽̌͑̈́i̻̙̯͙̯̊̂͛̓̉̊̉̎͜͢͠ B̶̰͈̯̙̤̓̏͊̓̄̂̄͗͌̚r͖̹͇͉̱͎͗̆̔͑͆̄̒̅̚͟o̢͇̱͈̯͋̾͐̌͡͠k̖̯̣̲̟̀̏̔̐́͐̅͢͟͞͝o̴̧̠̪͈̙̪̹̳̙̼̿͆̒̀͆͒̕͞Ḷ̙̥͚͍͇̃̓̾̾̇͐͠͠͝͝i͉͕̳̘͍̙̲͐͊́́̍̈͊͢ͅ  ☆
╚════════════════════
"""
helo=""

KAC=[cl,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10,k1,k2,k3,k4,k5,k6,k7]
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,ki10mid,k1,k2,k3,k4,k5,k6,k7,'u340280b7b8c4529cca991f201aff121b']
admsa = 'u340280b7b8c4529cca991f201aff121b'
admin = 'u340280b7b8c4529cca991f201aff121b'
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Thanks For Add ☆  Aku Ga Jawab PM Karna aq Cuma Bot Protect  ☆ €̤̥̦̗͔͐̉̐̂́d̺̯͕̮̳͛̍͑̀͋̈͞͞͠͡d͔̭̜̝̻̠́̂̌̽̌͑̈́i̻̙̯͙̯̊̂͛̓̉̊̉̎͜͢͠ B̶̰͈̯̙̤̓̏͊̓̄̂̄͗͌̚r͖̹͇͉̱͎͗̆̔͑͆̄̒̅̚͟o̢͇̱͈̯͋̾͐̌͡͠k̖̯̣̲̟̀̏̔̐́͐̅͢͟͞͝o̴̧̠̪͈̙̪̹̳̙̼̿͆̒̀͆͒̕͞Ḷ̙̥͚͍͇̃̓̾̾̇͐͠͠͝͝i͉͕̳̘͍̙̲͐͊́́̍̈͊͢ͅ\n\n\Support By ~ ҳ̸Ҳ̸ҳ Сўв∝я тҝ ҳ̸Ҳ̸ҳ\n\n✯==== Creator ====✯\n\nhttp://line.me/ti/p/~eddie.thansild.com",
    "lang":"JP",
...
#--------------------------------------------------------                    
                ...
                profile = ki2.getProfile()
                text = profile.displayName + ""
                ki2.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
                profile = ki3.getProfile()
                text = profile.displayName + ""
                ki3.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
                profile = ki4.getProfile()
                text = profile.displayName + ""
                ki4.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
                profile = ki5.getProfile()
                text = profile.displayName + ""
                ki5.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
                profile = ki6.getProfile()
                text = profile.displayName + ""
                ki6.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
                profile = ki7.getProfile()
                text = profile.displayName + ""
                ki7.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
                profile = ki8.getProfile()
                text = profile.displayName + ""
                ki8.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
                profile = ki9.getProfile()
                text = profile.displayName + ""
                ki9.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
                profile = ki10.getProfile()
                text = profile.displayName + ""
                ki10.sendText(msg.to, "☆✍Ŧ€₳M ж Ħ₳ʗҜ฿❂Ŧ☆")
#--------------------------------------------------------                
              ...
              if msg.from_ in admin:
                ...
                md = "╔════════════════════════\n╠[❂͜͡➣☀⏩ €̤̥̦̗͔͐̉̐̂́d̺̯͕̮̳͛̍͑̀͋̈͞͞͠͡d͔̭̜̝̻̠́̂̌̽̌͑̈́i̻̙̯͙̯̊̂͛̓̉̊̉̎͜͢͠ B̶̰͈̯̙̤̓̏͊̓̄̂̄͗͌̚r͖̹͇͉̱͎͗̆̔͑͆̄̒̅̚͟o̢͇̱͈̯͋̾͐̌͡͠k̖̯̣̲̟̀̏̔̐́͐̅͢͟͞͝o̴̧̠̪͈̙̪̹̳̙̼̿͆̒̀͆͒̕͞Ḷ̙̥͚͍͇̃̓̾̾̇͐͠͠͝͝i͉͕̳̘͍̙̲͐͊́́̍̈͊͢ͅ ⏪☀\n╠════════════════════\n"
                if wait["contact"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ Cᴏɴᴛᴀᴄᴛ ✒ ✅\n"
                else: md+="􀠁􀆩􏿿╠[❂͜͡➣ Cᴏɴᴛᴀᴄᴛ  ✒ ⛔\n"
                if wait["autoJoin"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ Aᴜᴛᴏ Jᴏɪɴ ✒ ✅\n"
                else: md +="􀠁􀆩􏿿╠[❂͜͡➣ Aᴜᴛᴏ Jᴏɪɴ  ✒ ⛔\n"
                if wait["autoCancel"]["on"] == True:md+="􀠁􀆩􏿿╠[❂͜͡➣ Gʀᴏᴜᴘ Cᴀɴᴄᴇʟ: " + str(wait["autoCancel"]["members"]) + " ✒ ✅\n"
                else: md+= "􀠁􀆩􏿿╠[❂͜͡➣ Gʀᴏᴜᴘ Cᴀɴᴄᴇʟ  ✒ ⛔\n"
                if wait["leaveRoom"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ Aᴜᴛᴏ Lᴇᴀᴠᴇ ✒ ✅\n"
                else: md+="􀠁􀆩􏿿╠[❂͜͡➣ Aᴜᴛᴏ Lᴇᴀᴠᴇ  ✒ ⛔\n"
                if wait["timeline"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ Sʜᴀʀᴇ ✒ ✅\n"
                else:md+="􀠁􀆩􏿿╠[❂͜͡➣ Sʜᴀʀᴇ  ✒ ⛔\n"
                if wait["autoAdd"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ Aᴜᴛᴏ Aᴅᴅ ✒ ✅\n"
                else:md+="􀠁􀆩􏿿╠[❂͜͡➣ Aᴜᴛᴏ Aᴅᴅ  ✒ ⛔\n"
                if wait["protect"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ Pʀᴏᴛᴇᴄᴛ ✒ ✅\n"
                else:md+="􀠁􀆩􏿿╠[❂͜͡➣ Pʀᴏᴛᴇᴄᴛ  ✒ ⛔\n"
                if wait["linkprotect"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ Uʀʟ Pʀᴏᴛᴇᴄᴛ ✒ ✅\n"
                else:md+="􀠁􀆩􏿿╠[❂͜͡➣ Uʀʟ Pʀᴏᴛᴇᴄᴛ  ✒ ⛔\n"
                if wait["inviteprotect"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ ɪɴᴠɪᴛᴇ Pʀᴏᴛᴇᴄᴛ ✒ ✅\n"
                else:md+="􀠁􀆩􏿿╠[❂͜͡➣ ɪɴᴠɪᴛᴇ Pʀᴏᴛᴇᴄᴛ  ✒ ⛔\n"
                if wait["cancelprotect"] == True: md+="􀠁􀆩􏿿╠[❂͜͡➣ Cᴀɴᴄᴇʟ ᴘʀᴏᴛᴇᴄᴛ ✒ ✅\n╠════════════════════\n╠[❂͜͡➣line://ti/p/~eddie.thansild.com\n╚════════════════════════"
                else:md+="􀠁􀆩􏿿╠[❂͜͡➣ Cᴀɴᴄᴇʟ ᴘʀᴏᴛᴇᴄᴛ  ✒ ⛔\n╠════════════════════\n╠[❂͜͡➣line://ti/p/~eddie.thansild.com\n╚════════════════════════"
...
#-----------------------------------------------------------)
                ...
                if msg.from_ in admin:
                    cl.sendText(msg.to,"╔═════════════════════\n║ ☀☫ȗ̸̥̩͕͈̺̭͍̠̫̇̑̃̽̈̇̆͆u̸̢̼͔͍͍̲͈͒̒́̇̌̑͆̃͞s̴̢͇̝͚̜̳̪̆́̆͗̕ B͇̗̟͚̲̰̣̔̀̃͊͗̈̕͟ͅỏ̦̫͍̟̥̜̝̑̀̉͌́̈́̕͝t̵̢̛̰̫̮̩̦͕̍̑̍͘s͕̦͚͖̄̔͊̀͑̾͌͘͘͟͡☫☀\n║™σρєη σя∂єя™«\n╠═════════════════════\n╠➩☬ѕєℓƒтвσт σηℓу\n╠➩☬ѕєℓƒтвσт + αѕιѕт\n╠➩☬1 αкυη υтαмα\n╠➩☬1αкυη υтαмα + 2 αѕιѕт\n╠➩☬1αкυη υтαмα + 3 αѕιѕт\n╠➩☬1αкυη υтαмα + 4 αѕιѕт\n╠➩☬1αкυη υтαмα  + 5 αѕιѕт\n╠➩☬ρяσтє¢твσт 3-20 вσт αѕѕιѕт\n╠═════════════════════\n║     ☟ мιηαт ѕιℓαнαη нυв☟\n╠➩line://ti/p/~eddie.thansild.com\n╠➩line://ti/p/~bajak.id\n╠➩line://ti/p/~bayuapoy.com\n╠➩ тякмαкαѕιн	✍\n║═════════════════════\n╠➩C̽̅̈́̅ŕ̛̋͛e͛̃̾̍ǻ̕͘t͒̉̈̎o͊̓̌͠r̐̇̾̐ B̝̪̭͓͍̺͐͂̑̅̓͗͗̈́͢y͚͔̝͖̮̤͚̅̉̑̐̓̀̋̊͂͜͜͢͞:̶̨̻̪͓̦̻̋̾̂̽̎͘͜͜ B̷̭͖̯͉̲͛̍̃̒͐̂͘͟r̨̟̖͕̬̳͓̖̈́̈́̇̈́̂̄̕̚͞͠o͍͍̬̼̥̺̣̯̻̣̿̏͒͊̾̔k̩͚̪̙̹̭͇̈́͂̾̏̋̽̂́͝ǫ̶̨̧̺̫͚͙̤̥͇̃́͆̎͐̔̌̃̒͑L̸̨̟͇͉̦̠̺̇̽̈́̓̊̕͟͢͞L͖̲̦̰̼̳̝͒́͌͒͂͑͋̕̚͜͟i̧̨͕̘͍̦͕̽̓̆̓̆͘͟~ery༻>\n║ȗ̸̥̩͕͈̺̭͍̠̫̇̑̃̽̈̇̆͆u̸̢̼͔͍͍̲͈͒̒́̇̌̑͆̃͞s̴̢͇̝͚̜̳̪̆́̆͗̕ B͇̗̟͚̲̰̣̔̀̃͊͗̈̕͟ͅỏ̦̫͍̟̥̜̝̑̀̉͌́̈́̕͝t̵̢̛̰̫̮̩̦͕̍̑̍͘s͕̦͚͖̄̔͊̀͑̾͌͘͘͟͡					~usro\n║ ═════════════════════\n╠➩ Support By: χχχ==вσтρяσтє¢т==χχχ\n╚══════════════════════")               
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': admsa}
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            ...
                            pass
            elif "Gasak" in msg.text:
              if msg.from_ in admin:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Gasak","")
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    gs = ki3.getGroup(msg.to)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            if not target in Bots:
                                try:
                                   klist=[ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10,k1,k2,k3,k4,k5,k7,k8]
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        k2.sendText(msg.to,"Bye Bye😘 "  +  str(ginfo.name)  + "")
                        k3.sendText(msg.to,"Bye Bye😘 "  +  str(ginfo.name)  + "")
                        k4.sendText(msg.to,"Bye Bye😘 "  +  str(ginfo.name)  + "")
                        k5.sendText(msg.to,"Bye Bye😘 "  +  str(ginfo.name)  + "")
                        k6.sendText(msg.to,"Bye Bye😘 "  +  str(ginfo.name)  + "")
