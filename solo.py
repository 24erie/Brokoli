...
cl = BROKOLI.LINE()
cl.login(token="EsSyDUjgapAcpMb8v3Kb.nakaT7JeuPZkMr8GgV8sgW.hwliMjbcnzUlKQACaaAG2YsK2IRTarEAnhSCgJ2To/Q=")
cl.loginResult()

print u"╔════════════════\n╠[❂͜͡➣login success BROKOLI\n╚════════════════"
reload(sys)
...
#--------------------------------------------------------                    
                ...
                cl.sendText(msg.to, "☆ TK  B̴̡̛͈̖̺͖̙̝̩̞̐̂̀͂̏̚͟͠O̊̑̾͘T Ç̵͔̟̫̰̮̺̟̥̂̋̂͋͐͛͑̔̚̚O̷̧̺̠̰̳̿́͆̕̕͠ͅ N̶͖̜̻̰͍̮̼̒́̐̑͒́̕ͅŢ̢̯̱͕̠͙̤̙̄̂͗̊̈́̕R̶̛̙̩̱̗̯͌̈͆̆Ơ̴̡͈̖̺͖̙̝̩̞̐̂̀͂̏̚͟͠L̸̡̩̣̲̣̜̊̑̾̾͊̃͘͜ͅ  ☆")
                profile = ki2.getProfile()
                text = profile.displayName + ""
...
#--------------------------------------------------------                
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto Protect on🔓✍")
                ...
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cancel Protect on✍ 􀜁􀇔􏿿👈")
                    else:
                        cl.sendText(msg.to,"Hal ini sudah terbuka ô€¨👈")
                else:
                ...
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto Login on✍")
                    else:
                        cl.sendText(msg.to,"Hal ini sudah terbuka ô€¨👈")
                else:
                    wait["autoJoin"] = True
              ...
              if msg.from_ in admin:
                ...
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto Protect off🔓✍")
                ...
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Qr protect off✍")
                    else:
                        cl.sendText(msg.to,"sudah dimatikan ô€œô€„‰👈")
                else:
                    wait["linkprotect"] = False
                ...
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Share on ✍ 􀜁􀇔􏿿")
                    else:
                ...
                if wait["autoJoin"] == True: md+="╠[❂͜͡➣ Aᴜᴛᴏ Jᴏɪɴ ✒ ✅\n"
                else: md +="╠[❂͜͡➣ Aᴜᴛᴏ Jᴏɪɴ  ✒ ⛔\n"
                if wait["autoCancel"]["on"] == True:md+="╠[❂͜͡➣ Gʀᴏᴜᴘ Cᴀɴᴄᴇʟ: " + str(wait["autoCancel"]["members"]) + " ✒ ✅\n"
                else: md+= "╠[❂͜͡➣ Gʀᴏᴜᴘ Cᴀɴᴄᴇʟ  ✒ ⛔\n"
                if wait["leaveRoom"] == True: md+="╠[❂͜͡➣ Aᴜᴛᴏ Lᴇᴀᴠᴇ ✒ ✅\n"
                else: md+="╠[❂͜͡➣ Aᴜᴛᴏ Lᴇᴀᴠᴇ  ✒ ⛔\n"
                if wait["timeline"] == True: md+="╠[❂͜͡➣ Sʜᴀʀᴇ ✒ ✅\n"
                else:md+="╠[❂͜͡➣ Sʜᴀʀᴇ  ✒ ⛔\n"
                if wait["autoAdd"] == True: md+="╠[❂͜͡➣ Aᴜᴛᴏ Aᴅᴅ ✒ ✅\n"
                else:md+="╠[❂͜͡➣ Aᴜᴛᴏ Aᴅᴅ  ✒ ⛔\n"
                if wait["protect"] == True: md+="╠[❂͜͡➣ Pʀᴏᴛᴇᴄᴛ ✒ ✅\n"
                else:md+="╠[❂͜͡➣ Pʀᴏᴛᴇᴄᴛ  ✒ ⛔\n"
                if wait["linkprotect"] == True: md+="╠[❂͜͡➣ Uʀʟ Pʀᴏᴛᴇᴄᴛ ✒ ✅\n"
                else:md+="╠[❂͜͡➣ Uʀʟ Pʀᴏᴛᴇᴄᴛ  ✒ ⛔\n"
                if wait["inviteprotect"] == True: md+="╠[❂͜͡➣ ɪɴᴠɪᴛᴇ Pʀᴏᴛᴇᴄᴛ ✒ ✅\n"
                else:md+="╠[❂͜͡➣ ɪɴᴠɪᴛᴇ Pʀᴏᴛᴇᴄᴛ  ✒ ⛔\n"
                if wait["cancelprotect"] == True: md+="╠[❂͜͡➣ Cᴀɴᴄᴇʟ ᴘʀᴏᴛᴇᴄᴛ ✒ ✅\n╠════════════════════\n╠[❂͜͡➣line://ti/p/~eddie.thansild.com\n╚════════════════════════"
                else:md+="╠[❂͜͡➣ Cᴀɴᴄᴇʟ ᴘʀᴏᴛᴇᴄᴛ  ✒ ⛔\n╠════════════════════\n╠[❂͜͡➣line://ti/p/~eddie.thansild.com\n╚════════════════════════"
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"􀜁􀇔􏿿 Dont Kick out From group  ")
 ...
 #------------------------------------------------------------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.sendMessage(msg)
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'uab732b67ee0e915b9723bb605e940e0b'}
                    cl.sendMessage(msg)
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"""      􀜁􀇔􏿿􀜁􀇔􏿿 CYBER TK BOT [TK] 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[TK1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[TK1 Gift]\n􀜁􀇔􏿿[TK1 bye]\n\n   
